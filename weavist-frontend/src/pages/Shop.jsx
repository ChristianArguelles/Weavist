    ...
    <div className="container py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <button
            onClick={() =>
              document.querySelector('input[aria-label="Search products"]').focus()
            }
          ...
          <div className="relative">
            ...
            {showFilters && (
              <div
                id="shop-filters"
                className="absolute right-0 mt-2 w-64 bg-white border rounded shadow-md p-3 z-40"
              >
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 text-sm">
                    <input
                      ...
                      onChange={(e) =>
                        setFilters((f) => ({ ...f, handwoven: e.target.checked }))
                      }
                    />
                    Handwoven
                  </label>
                  <label className="flex items-center gap-2 text-sm">
                    <input
                      ...
                      onChange={(e) =>
                        setFilters((f) => ({ ...f, scarves: e.target.checked }))
                      }
                    />
                    Scarves
                  </label>
                  <label className="flex items-center gap-2 text-sm">
                    <input
                      ...
                      onChange={(e) =>
                        setFilters((f) => ({ ...f, bags: e.target.checked }))
                      }
                    />
                    Bags
                  </label>
                ...
                <div className="mt-3 flex justify-between">
                  <button
                    ...
                    onClick={() =>
                      setFilters({ handwoven: false, scarves: false, bags: false })
                    }
                  >
                    Clear
                  </button>
